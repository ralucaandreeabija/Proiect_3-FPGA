...
(În implementarea actuală, scrierea de date propriu-zise nu este utilizată; se setează doar pointer-ul de registru.)
...
FSM de citire periodică – citește temperatura la aproximativ 0,5 s (contor de 50 000 000 cicluri la 100 MHz). Include mecanism de timeout (500 000 cicluri) atât la pornirea tranzacției, cât și la așteptarea semnalului done, pentru a preveni blocarea în caz de eroare pe magistrală.
